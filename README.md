...
![x]]https://recordit.co/j9HVUjUYfB
![](gif2-link-here)
![](gif3-link-here)
![](gif4-link-here)
...
i used w3 school to look up how to implement a random javascript array with values inbetween two integers. I then used the monzilla developer website to look up how to implement an array that can be populated with the randomly generated integer values.
